                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title float-right">
                                    <a class="btn btn-success" href="{{ url('NPanel/rooms/crud') }}"> <i
                                            class="fas fa-plus"></i> <span>Oda Ekle</span> </a>
                                </h3>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <a class="btn btn-dark"
                                                href="{{ url('NPanel/rooms/crud/' . $room['id']) }}"><i
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ url('NPanel/rooms/delete/' . $room['id']) }}"
