$(function () {
    ...
    window.addEventListener('scroll', function() {
        var isSticked = document.querySelector('header').classList.contains('sticked');
        
        if (isSticked) {
            document.querySelector('.logo-desktop').src = '../assets/images/logo.png';
        } else {
            document.querySelector('.logo-desktop').src = '../assets/images/mavikoybeachresort.png';
        }
    });
